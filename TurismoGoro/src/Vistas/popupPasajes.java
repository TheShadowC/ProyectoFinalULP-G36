...
import AccesoADatos.Pasaje_Data;
 ...
 * @author USUARIO
 */
public class popupPasajes extends javax.swing.JInternalFrame {
    ...
    public void listarPasajes() {
        ...
        list = listar.listarPasajes();
        for (Pasaje pas : list) {
            modeloTabla.addRow(new Object[]{pas.getIdPasajero(), pas.getNombreCiudadO().getNombre(), pas.getNombreCiudadD().getNombre()});
