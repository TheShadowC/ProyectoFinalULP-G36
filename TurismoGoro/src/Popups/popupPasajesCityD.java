 ...
 * @author USUARIO
 */
public class popupPasajesCityD extends javax.swing.JInternalFrame {
    ...
    private void pasajesTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pasajesTableMouseClicked
        VentanaPasaje.jTCiudadDestino.setText(modeloTabla.getValueAt(pasajesTable.getSelectedRow(), 1).toString().toUpperCase()+" - "+modeloTabla.getValueAt(pasajesTable.getSelectedRow(), 2).toString()+", "+modeloTabla.getValueAt(pasajesTable.getSelectedRow(), 3).toString() );
        VentanaPasaje.jLidCD.setText((modeloTabla.getValueAt(pasajesTable.getSelectedRow(), 0).toString()));
        this.dispose();
