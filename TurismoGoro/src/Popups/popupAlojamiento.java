 ...
 * @author USUARIO
 */
public final class popupAlojamiento extends javax.swing.JInternalFrame {
    ...
    private void pasajesTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pasajesTableMouseClicked
        VentanaAlojamiento.jTId.setText((modeloTabla.getValueAt(pasajesTable.getSelectedRow(), 0).toString()));
        VentanaAlojamiento.jLidCiudad.setText((modeloTabla.getValueAt(pasajesTable.getSelectedRow(), 4).toString()));
        this.dispose();
    ...
    public void listarAlojamientos() {
        ...
        list = listar.listarAlojamientos();
        for (Alojamiento al : list) {
            modeloTabla.addRow(new Object[]{al.getIdAlojamiento(), al.getCiudadDest().getNombre(), al.getTipoAlojamiento(), al.getTipoServicio(), al.getCiudadDest().getIdCiudad()});
        }
            ocultarColumnas(pasajesTable, new int[] {4});
    }
