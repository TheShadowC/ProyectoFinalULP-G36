 ...
 * @author USUARIO
 */
public final class popupPresupuestosCO extends javax.swing.JInternalFrame {
    ...
    private void cityTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cityTableMouseClicked
        ...
        VentanaPresupuesto.ciudadOrigenPaquete = city;
        VentanaPresupuesto.jTFCO.setText(city.toString());
        VentanaPresupuesto.idCO.setText(((modeloTabla.getValueAt(cityTable.getSelectedRow(), 0).toString())));
        VentanaPresupuesto.jBCD.setEnabled(true);
        VentanaPresupuesto.jTFCD.setEnabled(true);
        VentanaPresupuesto.jTFCO.setEnabled(true);
        this.dispose();
    ...
    public void listarCiudades() {
        ...
        List<Ciudad> list = listar.obtenerCiudades();
